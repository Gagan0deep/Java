...
public class s4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<div style='background-color:gray;border-radius:8px;width:400px;transform:translate(300px,150px);padding:10px;font-weight:bold;font-family:Comic Sans MS;font-size:20px'>Login<br/></div><div style='background-color:silver;width:400px;transform:translate(300px,143px);padding:10px;'><br/>"
                    ...
                    + "<button style='padding:8px;border-radius:8px;transform:translate(120px,0px);'>Sign in</button><br/><br/></div></div><div style='background-color:gray;width:400px;transform:translate(300px,140px);padding:5px 10px 5px 10px;'><br/></div></div><br/><br/><br/><br/><br/><br/><br/><br/>");
            out.println("<div style='width:50%;transform:translate(0,100px);background:linear-gradient(to right,silver,red);'><br/></div><div style='width:50%;transform:translate(480px,82px);background-color:red;'><br/></div>");
            out.println("<style>"
            ...
            out.println("<p style='color:gray;transform:translate(660px,-512px);'><span style='color:red'>Contact:</span> xyz@gmail.com; <span style='color:red'/>Ph.</span> 0123456789</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
