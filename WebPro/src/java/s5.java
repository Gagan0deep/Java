...
public class s5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<div style='background-color:gray;border-radius:8px;width:500px;transform:translate(220px,50px);text-align:center;padding:10px;font-size:20px;font-weight:bold;font-family:Comic Sans MS'>Register<br/></div><div style='background-color:silver;width:500px;transform:translate(220px,45px);padding:10px;'><br/>"
            ...
            out.println("<p style='color:gray;transform:translate(660px,-550px);'><span style='color:red'>Contact:</span> xyz@gmail.com; <span style='color:red'/>Ph.</span> 0123456789</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
